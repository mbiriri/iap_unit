    ...
    <div class="row align-items-md-stretch">
        ...
        <div class="col-md-6">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                ...
                <p>Join the ICS Community to connect with fellow students, share resources, and stay updated with the latest events and opportunities in the field of Information and Computer Science.</p>
                <p>Our platform provides a space for collaboration, learning, and professional growth.</p>
